...
(* OASIS_START *)
(* DO NOT EDIT (digest: 905bdac861fc340a8e584fb79a8e0179) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("amall", None);
                           FindlibPackage ("amall.dbi", None);
                           FindlibPackage ("cadastr", None);
                           FindlibPackage ("threads", None);
                           FindlibPackage ("cmdliner", None);
                           FindlibPackage ("input_float", None);
                   ...
                   {exec_custom = false; exec_main_is = "dresina.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\255\160<\151\025$\028\004X\214mk~\215\195\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
